...
progressRouter.get('/relations', (req, res) => { progressController.relations(req, res) })
progressRouter.post('/', (req, res) => { progressController.create(req, res) })
progressRouter.post('/addRelation', (req, res) => { progressController.addRelation(req, res) })
